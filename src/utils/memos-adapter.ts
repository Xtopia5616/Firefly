...
const sanitizeDynamicHtml = (html: string): string =>
	sanitizeHtml(html, {
		allowedTags: [
			"p",
			"br",
...
function markdownToHtml(markdown: string): string {
	return sanitizeDynamicHtml(memosMarked.parse(markdown) as string);
}
...
export async function fetchMemos(
	...
	const cleanup = () => pendingRequests.delete(cacheKey);
